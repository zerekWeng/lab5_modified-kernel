...
static void hybla_init(struct sock *sk)
{
	...
	// LAB5 change: default to 1
	tcp_snd_cwnd_set(tp, 1);

	// tp->snd_cwnd_clamp = 65535;
	// LAB5 change: default to optimum BDP
	tp->snd_cwnd_clamp = TCP_INIT_CWND << 2;
...
static void hybla_cong_avoid(struct sock *sk, u32 ack, u32 acked)
{
	...
	while (ca->snd_cwnd_cents >= 128) {
		...
		// LAB5 change: make AI more aggressive
	...
	if (is_slowstart)
		...
		// LAB5 change: cap the send window to maximum
